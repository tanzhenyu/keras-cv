...
def build_ssd_vgg16_fpn(input_shape):
    feature_maps = []
...
def build_ssd_vgg16_head(ssd_vgg16_fpn, n_classes=21):
...
def train_eval_save():
    ...
    ssd_vgg16_fpn = build_ssd_vgg16_fpn((300, 300, 3))
    gt_loc_pred, gt_cls_pred = build_ssd_vgg16_head(ssd_vgg16_fpn)
