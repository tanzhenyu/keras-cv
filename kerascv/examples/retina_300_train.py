...
def build_retina_vgg16_fpn(input_shape, l2_reg=0.0005):
    feature_maps = []
...
def build_retina_vgg16_head(retina_vgg16_fpn, l2_reg=0.0005, n_classes=21):
    feature_maps = retina_vgg16_fpn.outputs
...
def train_eval_save():
    ...
    retina_vgg16_fpn = build_retina_vgg16_fpn((300, 300, 3), l2_reg=0.005)
    gt_loc_pred, gt_cls_pred = build_retina_vgg16_head(retina_vgg16_fpn, l2_reg=0.005)
    ...
    print('-------------------Start Saving-------------------')
    train_model.save('retina_300.h5')
